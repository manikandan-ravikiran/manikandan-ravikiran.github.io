...
- Organizer: Workshop on Handling Resource Constraints for/using ML (IEEE Bigdata 2024), Fourth Workshop on
Speech and Language Technologies for Dravidian Languages (EACL 2024), Special Session on Machine Learning for
Graphs (IEEE ICMLA 2023) , Special Session on Handling Resource Constraints for/using ML (IEEE ICMLA 2023),
Workshop on Low Resource Cross-Domain, Cross-Lingual & Cross-Modal Offensive Content Analysis (SPELLL 2022,
2023), Workshop of Cross Modal Learning and Application (ACM ICMR 2019)
